Vídeos da sessão vídeos:
       ...
       <li class="videos__item">
            <iframe width="100%" height="72%" src="https://www.youtube.com/embed/xrRy3RI3HE4?si=Lbd9BIBL4-SCePVk" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>

            <div class="descricao-video">
                <img src="./img/videos/Ellipse 11.png" alt="Logo do canal Alura Cursos Online">
                <h3>Diferença entre Back-End e Front-End com Mario Souto</h3>
                <p>47 mil visualizações - Há 2 anos</p>
            </div>
        </li>
        <li class="videos__item">
            <iframe width="100%"  height="72%" src="https://www.youtube.com/embed/6lOsIZHt67M?si=sKrzrKZVSsPCKckx"
                title="Se prepare para entrevistas de vagas de Analista de Dados" frameborder="0"
                allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
                allowfullscreen></iframe>
            <div class="descricao-video">
                <img src="./img/videos/Ellipse 11.png" alt="Logo do canal Alura Cursos Online">
                <h3>Se prepare para entrevistas de vagas de Analista de Dados</h3>
                <p>2 mil visualizações - Há 2 meses</p>
            </div>
        </li>
        <li class="videos__item">
        ...
        <li class="videos__item">
            <iframe width="100%"  height="72%" src="https://www.youtube.com/embed/GEljZeWTVec?si=y0Ex0LSaYGMrDWs8"
                title="Se prepare para entrevistas de vagas de Front-End" frameborder="0"
                allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
                allowfullscreen></iframe>
            <div class="descricao-video">
                <img src="./img/videos/Ellipse 11.png" alt="Logo do canal Alura Cursos Online">
                <h3>Se prepare para entrevistas de vagas de Front-End</h3>
                <p>100 mil visualizações - Há 4 meses</p>
            </div>
        </li>
        <li class="videos__item">
